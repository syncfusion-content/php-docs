...
The following procedure illustrates how to install Essential Studio for PHP Online Installer. 

1.  Double-click the Syncfusion PHP Online Installer setup file. The Setup Wizard opens and extracts the package automatically.
